package pt.ual.mgi.integration.client;
...
import pt.ual.mgi.filter.auth.RestAuthClientRequestFilter;
...
public class ApiClient {
  ...
  private String basePath = "http://localhost:8280/scmgi/service/identities";
  ...
  */
  ...
  private Client buildHttpClient(boolean debugging) {
    ...
    clientConfig.register(RestAuthClientRequestFilter.class);
    if (debugging) {
